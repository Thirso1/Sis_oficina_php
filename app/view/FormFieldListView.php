...
class FormFieldListView extends TPage
{
    ...
    public function __construct()
    {
        ...
        $combo->enableSearch();
        $combo->addItems(['1'=>'<b>Telefone</b>','2'=>'<b>Email</b>','3'=>'<b>Whatsapp</b>','4'=>'<b>Facebook</b>','5'=>'<b>Site</b>','6'=>'<b>Twitter</b>']);
        $combo->setSize('100%');
        ...
        $this->fieldlist->addField( '<b>Tipo</b>',  $combo,  ['width' => '25%'] );
        $this->fieldlist->addField( '<b>Contato</b>',   $text,   ['width' => '25%'] );
